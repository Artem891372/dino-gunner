      ...
      >
        ...
        <div className="space-y-4 text-xs font-pixel leading-relaxed">
          ...
          >
            ...
            <p className="text-[10px] opacity-80">
              Переключайтесь между классической светлой темой (Google Dino Desert) и киберпанк темной ночью с луной, звездами и неоновой подсветкой.
            </p>
          </div>
          ...
          >
            ...
            <ul className="list-disc list-inside text-[9px] opacity-75 space-y-1">
              <li>Параллакс: дальние холмы и ближние дюны движутся с разной скоростью.</li>
              <li>День сменяется закатом, ночью и рассветом по таймеру; погода — дождь, снег или песчаная буря.</li>
